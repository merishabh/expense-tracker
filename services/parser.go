...
func ParseCreditCardTransaction(text string, dbClient models.DatabaseClient, groqClient *ai.GroqClient) *models.Transaction {
	...
	if len(match) == 6 {
		...
		return &models.Transaction{
			...
			Vendor:     vendor,
			DateTime:   dt,
			Category:   CategorizeTransaction(vendor, dbClient, groqClient),
		}
	}
...
func ParseBankTransaction(text string, dbClient models.DatabaseClient, groqClient *ai.GroqClient) *models.Transaction {
...
func ParseICICICreditCardTransaction(text string, dbClient models.DatabaseClient, groqClient *ai.GroqClient) *models.Transaction {
...
func ParseCardPaymentTransaction(text string, dbClient models.DatabaseClient, groqClient *ai.GroqClient) *models.Transaction {
...
func ParseIMPSPaymentTransaction(text string, dbClient models.DatabaseClient, groqClient *ai.GroqClient) *models.Transaction {
...
func CategorizeTransaction(vendor string, dbClient models.DatabaseClient, groqClient *ai.GroqClient) string {
	if vendor == "" {
		return "Other"
	}
	...
	// 3. Use Groq AI as fallback
	if groqClient != nil {
		if aiCategory, err := groqClient.ClassifyVendor(vendor); err == nil && aiCategory != "" {
